...
class RegFHVAE_unidirectional_3layers(tf.keras.Model):
    ...
    def __init__(self, z1_dim=32, z2_dim=32, z1_rhus=[256, 256, 256], z2_rhus=[256, 256, 256], x_rhus=[256, 256, 256],
        ...
        super(RegFHVAE_unidirectional_3layers, self).__init__(name=name, **kwargs)
...
class Encoder(layers.Layer):
    ...
    def __init__(self, z1_dim=32, z2_dim=32, z1_rhus=[256,256], z2_rhus=[256,256],
        ...
        self.lstm_layer2_z2 = layers.LSTM(self.z2_rhus[1], return_sequences=True, return_state=True, time_major=False)
        self.lstm_layer3_z2 = layers.LSTM(self.z2_rhus[2], return_state=True, time_major=False)
        ...
        self.lstm_layer2_z1 = layers.LSTM(self.z1_rhus[1], return_sequences=True, return_state=True, time_major=False)
        self.lstm_layer3_z1 = layers.LSTM(self.z1_rhus[2], return_state=True, time_major=False)
    ...
    def z2_pre_encoder(self, x):
        ...
        outputs3, final_memory_state3, final_carry_state3 = self.lstm_layer3_z2(inputs=outputs2, training=True)
        out = tf.concat([final_memory_state1, final_memory_state2, final_memory_state3], axis=-1)
    ...
    def z1_pre_encoder(self, x, z2):
        ...
        outputs3, final_memory_state3, final_carry_state3 = self.lstm_layer3_z1(inputs=outputs2, training=True)
        out = tf.concat([final_memory_state1, final_memory_state2, final_memory_state3], axis=-1)
...
class Decoder(layers.Layer):
    ...
    def __init__(self, x_rhus=[256,256], tr_shape=(20, 80),
        ...
        self.lstm_layer3_x = layers.LSTM(self.x_rhus[2], return_sequences=True, time_major=False)
