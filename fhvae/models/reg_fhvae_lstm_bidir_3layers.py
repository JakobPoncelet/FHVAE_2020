...
class RegFHVAE_bidirectional_3layers(tf.keras.Model):
    ''' combine the encoder and decoder into an end-to-end model for training '''

    def __init__(self, z1_dim=32, z2_dim=32, z1_rhus=[256, 256, 256], z2_rhus=[256, 256, 256], x_rhus=[256, 256, 256],
        ...
        super(RegFHVAE_bidirectional_3layers, self).__init__(name=name, **kwargs)
...
class Encoder(layers.Layer):
    ...
    def __init__(self, z1_dim=32, z2_dim=32, z1_rhus=[256,256,256], z2_rhus=[256,256,256],
        ...
        self.lstm_layer2_z2 = layers.Bidirectional(layers.LSTM(self.z2_rhus[1], return_sequences=True, return_state=True, time_major=False), merge_mode='concat')
        self.lstm_layer3_z2 = layers.Bidirectional(layers.LSTM(self.z2_rhus[2], return_state=True, time_major=False), merge_mode='concat')
        ...
        self.lstm_layer2_z1 = layers.Bidirectional(layers.LSTM(self.z1_rhus[1], return_sequences=True, return_state=True, time_major=False), merge_mode='concat')
        self.lstm_layer3_z1 = layers.Bidirectional(layers.LSTM(self.z1_rhus[2], return_state=True, time_major=False), merge_mode='concat')
    ...
    def z2_pre_encoder(self, x):
        ...
        outputs3, forward_h3, forward_c3, backward_h3, backward_c3 = self.lstm_layer3_z2(inputs=outputs2, training=True)
        out = tf.concat([forward_h1, backward_h1, forward_h2, backward_h2, forward_h3, backward_h3], axis=-1)
    ...
    def z1_pre_encoder(self, x, z2):
        ...
        outputs3, forward_h3, forward_c3, backward_h3, backward_c3 = self.lstm_layer3_z1(inputs=outputs2, training=True)
        out = tf.concat([forward_h1, backward_h1, forward_h2, backward_h2, forward_h3, backward_h3], axis=-1)
...
class Decoder(layers.Layer):
    ...
    def __init__(self, x_rhus=[256,256,256], tr_shape=(20, 80),
        ...
        self.lstm_layer3_x = layers.Bidirectional(layers.LSTM(self.x_rhus[2], return_sequences=True, time_major=False), merge_mode='concat')
    ...
    def call(self, x, z1, z2):
        ...
        outputs2 = self.lstm_layer2_x(inputs=outputs1, training=True)
        output = self.lstm_layer3_x(inputs=outputs2, training=True)
