...
class RegFHVAE_unidirectional(tf.keras.Model):
    ''' combine the encoder and decoder into an end-to-end model for training
        use unidirectional LSTMs for the encoders and the decoder '''
    ...
    def __init__(self, z1_dim=32, z2_dim=32, z1_rhus=[256, 256], z2_rhus=[256, 256], x_rhus=[256, 256],
        ...
        super(RegFHVAE_unidirectional, self).__init__(name=name, **kwargs)
